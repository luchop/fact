...
class Movimiento extends CI_Controller {
    ...
    function Nuevo() {
		...
		$this->form_validation->set_rules('Referencia', '"# recibo "', 'trim');
		$data['ComboCliente'] = $this->modelo_cliente->ComboCliente(True);
        ...
        if ($this->form_validation->run()) {
			...
			$data['Mensaje'] = "Se ha registrado un nuevo movimiento.";                        
            $data['VistaPrincipal'] = 'vista_mensaje';            
        } else
            $data['VistaPrincipal'] = 'vista_nuevo_ie';                                                
